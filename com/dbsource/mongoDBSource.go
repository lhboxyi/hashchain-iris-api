...
func Init() {
	var (
		dbhost     = viper.Get("mongo.dbhost").(string)
		authdb     = viper.Get("mongo.authdb").(string)
		authuser = viper.Get("mongo.username").(string)
		authpass   = viper.Get("mongo.password").(string)
